...
class StrategyPolicy(CorePolicy):
    ...
    posterior_budget_scale_probability: Decimal = Decimal("0.60")
    ...
    def from_mapping(cls, value: dict[str, Any] | None) -> "StrategyPolicy":
        ...
        data.update({
            ...
            "posterior_budget_scale_probability": _clamp(_dec(raw.get("posterior_budget_scale_probability"), "0.60"), Decimal("0.5"), Decimal("0.95")),
