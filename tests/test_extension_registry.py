...
class ExtensionRegistryTests(unittest.TestCase):
    ...
    def test_safety_sensitive_order_constraints_are_explicit(self):
        ...
        self.assertNotIn("budget_reservation_compat", EXTENSION_ORDER)
    ...
    def test_release_identity_is_consistent(self):
        ...
        self.assertEqual(project_version, manifest_version); self.assertEqual(__version__, manifest_version)
        ...
        self.assertIn("sealed-operation/control-policy generation v6.2", current_state)
