...
ARTIFACT_DIR="${FULL_SANDBOX_ARTIFACT_DIR:-$ROOT/artifacts/full-sandbox}"
...
record EXTERNAL amazon_live "Test Account Campaign hierarchy canary" "requires Amazon Test Account or bounded real profile"
